...
<div class="prenav">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <!--Setting hyperlinks to login and register-->
    <a href="Login.php">
...
<center>
    <div id="gametext">
        ...
        <div id="gamepic">
            ...
            <div class="Game">
                <p id="Card1">
                    <button id="AmateurCard1" onclick="Flip1()">
                        <i class="fa-sharp fa-solid fa-brain"></i>
                    </button>
                </p>
                <p id="Card2">
                    <button id="AmateurCard2" onclick="Flip2()">
                        <i class="fa-sharp fa-solid fa-brain"></i>
                    </button>
                </p>
                <br>
                <p id="Card3">
                    <button id="AmateurCard3" onclick="Flip3()">
                        <i class="fa-sharp fa-solid fa-brain"></i>
                    </button>
                </p>
                <p id="Card4">
                    <button id="AmateurCard4" onclick="Flip4()">
                        <i class="fa-sharp fa-solid fa-brain"></i>
                    </button>
                </p>
                <p id="Card5">
                    <button id="AmateurCard5" onclick="Flip5()">
                        <i class="fa-sharp fa-solid fa-brain"></i>
                    </button>
                </p>
                <p id="Card6">
                    <button id="AmateurCard6" onclick="Flip6()">
                        <i class="fa-sharp fa-solid fa-brain"></i>
                    </button>
                </p>
                <p id="Card7">
                    <button id="AmateurCard7" onclick="Flip7()">
                        <i class="fa-sharp fa-solid fa-brain"></i>
                    </button>
                </p>
                <p id="Card8">
                    <button id="AmateurCard8" onclick="Flip8()">
                        <i class="fa-sharp fa-solid fa-brain"></i>
                    </button>
                </p>
                <p id="Card9">
                    <button id="AmateurCard9" onclick="Flip9()">
                        <i class="fa-sharp fa-solid fa-brain"></i>
                    </button>
                </p>
                <p id="Card10">
                    <button id="AmateurCard10" onclick="Flip10()">
                        <i class="fa-sharp fa-solid fa-brain"></i>
                    </button>
                </p>
            </div>
            <!--Linking the game JS to this page. PHP part added so that the webpage responds to the changes in the JS file-->
            <script src="amateurgameguest.js?v=<?php echo time(); ?>">
            </script>
            <br>
        </div>
        <br>
