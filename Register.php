...
<?php
    ...
    myheader("CardFlip-Register");
    bannerNavigation("Register");
?>
<br><br><br><br><br><br>
<!--Adding a div named register to create a registration form asking for information like username, password, gender, mail etc-->
<div id="register">
    <b>
    ...
    <br><br>
    <!--Input tag used for setting up text boxes-->
    *Username:&nbsp;<input type="text" id="UsernameInput">
    <br><br>
    *Password:&nbsp;&nbsp;<input type="password" id="PasswordInput">
    <br><br>
    *Gender:&nbsp;&nbsp;&nbsp;&nbsp;
    <!--Select tag used for creating drop down options box-->
    ...
    <br><br>
    *Nationality:
    <!--Credit to https://www.html-code-generator.com/html/drop-down/country-names for the country select part of the code-->
    ...
    <br><br>
    *DOB:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="date" id="DobInput">
    <br><br>
    *Email:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="email" id="EmailInput">
    <br><br>
    Phone:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" id="PhoneInput">
    <br><br>
    ...
    <!--<a href = "login.php">-->
    <button id="create"
        style="background-color: rgb(68, 169, 252); color: rgb(255, 255, 255); width: 235; height: 35; font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; border-color: rgb(64, 105, 187); border-style: solid;"
        onclick="storeUser()">
...
<br><br>
<script src="register.js?v=<?php echo time(); ?>"></script>
<br><br>
<br><br>
<br><br>
<br><br>
