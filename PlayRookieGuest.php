...
?>
<br><br><br><br><br>
<!--Using center tag to allign content within it in center. This also includes the game-->
...
<center>
    <div id="gametext">
        ...
        <div id="gamepic">
            ...
            <script src="rookiegame.js?v=<?php echo time(); ?>"></script>
            <br>
        </div>
        <br>
        <!--Shows user score-->
